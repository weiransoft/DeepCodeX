 ...
 * - EAG-P5 Phase 5.4 新增：extractEagAutonomousRequestFromPrompt + EagAutonomousCommandHandler
 *
 * @module eag/cli
 */
...
// EAG-P5 Phase 5.4 TASK-P5-5.4-001：/eag-autonomous CLI 命令处理器（值导出，含运行期实现）
...
// EAG-P5 Phase 5.4 TASK-P5-5.4-001：/eag-autonomous 命令相关类型（类型导出）
export type {
